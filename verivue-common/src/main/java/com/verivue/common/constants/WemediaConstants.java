package com.verivue.common.constants;

public class WemediaConstants {

    public static final Short COLLECT_MATERIAL = 1; //Collect

    public static final Short CANCEL_COLLECT_MATERIAL = 0;//Cancel Collect
